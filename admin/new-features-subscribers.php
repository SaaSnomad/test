...
<?php  
    ...
    $db = new Database();
    // Run Query 
    $db->query("SELECT * FROM coming_soon_subscribers");
    // Assign Result Set
    $coming_soon_subscribers = $db->resultset();
?>
...
<!--/.Header-->
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect mdl-color--primary-dark">
          ...
          <a href="new-features-subscribers.php" class="mdl-layout__tab is-active">New Feature Subscribers</a>
            ...
            <div class="mdl-card mdl-cell mdl-cell--12-col">
              <div class="mdl-card__supporting-text">
                ...
                <table id="example" class="display nowrap" cellspacing="0" width="100%">
                  ...
                  <tbody>
                      <?php foreach($coming_soon_subscribers as $coming_soon_subscriber) : ?>
                      <tr>
                          <td><?php echo $coming_soon_subscriber->id; ?></td>
                          <td><?php echo $coming_soon_subscriber->coming_soon_email; ?></td>
                          <td><?php echo $coming_soon_subscriber->coming_soon_country; ?></td>
                          <td><?php echo $coming_soon_subscriber->date_added; ?></td>
                      </tr>
                      <?php endforeach; ?> 
                  </tbody>
              </table>
